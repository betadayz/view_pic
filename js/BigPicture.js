var BigPicture = (function () {
    ...
    function q(t) {
        ...
        if (!u) {
            if ((t > 0 && E === n) || (t < 0 && !E)) {
                if (!I.loop) return j(i, ""), void setTimeout(j, 9, i, "animation:" + (t > 0 ? "bpl" : "bpf") + " .3s;transition:transform .35s");
                E = t > 0 ? -1 : n + 1;
            }
            if (
    ...
    function R(n) {
        I.noLoader || (n && j(m, "top:" + t.offsetTop + "px;left:" + t.offsetLeft + "px;height:" + t.clientHeight + "px;width:" + t.clientWidth + "px"), t.parentElement[n ? O : V](m), (u = n));
    }
    function X(t) {
    ...
    function U(t) {
        if ((u && R(), T && T(), "string" == typeof t)) return $(), I.onError ? I.onError() : alert("Error: The requested " + t + " could not be loaded.");
        _ && F(s),
            (o.style.cssText += W()),
    ...
    function Y(t) {
        var n = t.target,
            i = [b, x, r, a, g, L, S, m];
        n && n.blur(), w || ~i.indexOf(n) || ((o.style.cssText += W()), j(e, "pointer-events:auto"), setTimeout($, 350), clearTimeout(k), (v = 0), (w = 1));
    }
    function $() {
            ...
            w.gallery
                ? (function (n, r) {
                      if (Array.isArray(n)) (A = n), (h = n[(E = r || 0)].caption);
                          ...
                          var a = (A = [].slice.call("string" == typeof n ? document.querySelectorAll(n + " [data-bp]") : n)).indexOf(t);
                          (E = 0 === r || r ? r : -1 !== a ? a : 0),
                              (A = A.map(function (t) {
                                  return { el: t, src: t.getAttribute("data-bp"), caption: t.getAttribute("data-caption") };
                              }));
                      }
                      (_ = 1), !~C.indexOf((s = A[E].src)) && R(1), A.length > 1 ? (e[O](H), (H.innerHTML = E + 1 + "/" + A.length), z || (e[O](S), e[O](L))) : (A = 0), ((o = i).src = s);
                  })(w.gallery, w.position)
                : d || w.iframeSrc
                ? ((o = c),
                  I.ytSrc ? (W = "https://www.youtube.com/embed/" + d + "?html5=1&rel=0&playsinline=1&autoplay=1") : I.vimeoSrc ? (W = "https://player.vimeo.com/video/" + d + "?autoplay=1") : I.iframeSrc && (W = I.iframeSrc),
                  j(m, ""),
                  c[O](m),
                  (p.src = W),
                  P(),
                ...
                ? (R(1),
                  ...
                  Array.isArray(D)
                      ...
                      : ((o = r).src = D),
                  G("video"))
                : ((o = i).src = "IMG" === t.tagName ? t.src : window.getComputedStyle(t).backgroundImage.replace(/^url|[(|)|'|"]/g, "")),
            e[O](o),
            document.body[O](e);
        var W;
    };
